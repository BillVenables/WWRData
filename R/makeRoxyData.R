...
#'
#' @return A character string vector, of class "RoxyData", with the roxygen template. By
#'     default, the output is copied to the clipboard and may be pasted into an R
#'     script directly.
#' @export
#'
#' @examples
